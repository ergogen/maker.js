...
(function (MakerJs) {
    ...
    (function (measure) {
        ...
        function isSlopeEqual(slopeA, slopeB) {
            ...
            // mrzealot mods: scale the intercepts to a uniform range
            // so that the larger distances don't disproportionately affect them
            var factor = 100 / slopeA.yIntercept;
            return MakerJs.round(100 - factor * slopeB.yIntercept, .00001) == 0;
        }
